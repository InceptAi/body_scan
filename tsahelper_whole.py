...
'''
sector01_pts = np.array([[0,0],[512,0],[512,330],[0,330]], np.int32)
sector02_pts = np.array([[0,0],[512,0],[512,330],[0,330]], np.int32)
sector03_pts = np.array([[0,0],[512,0],[512,330],[0,330]], np.int32)
sector04_pts = np.array([[0,0],[512,0],[512,330],[0,330]], np.int32)

sector05_pts = np.array([[0,160],[512,160],[512,400],[0, 400]], np.int32)

sector06_pts = np.array([[0,220],[512,220],[512,550],[0,550]], np.int32)
sector07_pts = np.array([[0,220],[512,220],[512,550],[0,550]], np.int32)
sector08_pts = np.array([[0,220],[512,220],[512,550],[0,550]], np.int32)
sector09_pts = np.array([[0,220],[512,220],[512,550],[0,550]], np.int32)
sector10_pts = np.array([[0,220],[512,220],[512,550],[0,550]], np.int32)

sector11_pts = np.array([[0,400],[512,400],[512,660],[0,660]], np.int32)
sector12_pts = np.array([[0,400],[512,400],[512,660],[0,660]], np.int32)
sector13_pts = np.array([[0,400],[512,400],[512,660],[0,660]], np.int32)
sector14_pts = np.array([[0,400],[512,400],[512,660],[0,660]], np.int32)
sector15_pts = np.array([[0,400],[512,400],[512,660],[0,660]], np.int32)
sector16_pts = np.array([[0,400],[512,400],[512,660],[0,660]], np.int32)
...
zone_slice_list = [ [ # threat zone 1
                    ...
                    [ # threat zone 5
                      sector05_pts, sector05_pts, sector05_pts, sector05_pts, None, None, None, None,
